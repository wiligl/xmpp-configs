...
admins = { "dandelionhub@ddhub.im" } -- EDITED
...
plugin_paths = { "/usr/lib/prosody/modules/" } -- EDITED
...
modules_enabled = {
	...
	-- Nice to have
		...
		-- "invites_register"; -- Allows invited users to create accounts -- EDITED
		...
		"turn_external"; -- Provide external STUN/TURN service for e.g. audio/video calls -- EDITED
	...
	-- HTTP modules
		"bosh"; -- Enable BOSH clients, aka "Jabber over HTTP" -- EDITED
		--"http_openmetrics"; -- for exposing metrics to stats collectors
		"websocket"; -- XMPP over WebSockets -- EDITED
	...
	-- Other specific functionality
		...
		"motd"; -- Send a message to users when they log in -- EDITED
...
turn_external_host = "turn.ddhub.im" -- EDITED
turn_external_port = 3478 -- EDITED

-- This secret must be set to the same value in both Prosody and the TURN server
turn_external_secret = "SetPasswordHere" -- EDITED
...
! DANDELION HUB IM (XMPP)
!
! "Seed Action. Harvest Change."
!
